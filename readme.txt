Binary Heap Implementation (SP3) version 1.0 09/23/2018
...
Since we have our class inside a package, the scope of this class is inside the package. Hence, navigate to the directory where the package directory (nxs180002) is present. Run the following command on Command Line to compile the java files-
	javac nxs180002/BinaryHeap.java
			or 
	javac nxs180002/*.java

The program should compile successfully. You can then run the program using the command - 

	java nxs180002.BinaryHeap
